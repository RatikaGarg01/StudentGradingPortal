	...
	<body>
		<div id="content">
			...
			<div id="mainmenu">
				<ul id="tabs">
					<li>
						<a href="#FacultyInformation" id="FacultyInformation-tab">Personal Information</a>
					</li>
					<li>
						<a href="#FacultyCoursesUndertaken" id="FacultyCoursesUndertaken-tab">Courses Undertaken</a>
					</li>
					<li>
						<a href="#FacultyGradingAndMarks" id="FacultyGradingAndMarks-tab">Grading And Marks</a>
					</li>
                    <li>
			...
			<div class="panel" id="FacultyCoursesUndertaken">
				...
				<form name="getcourse-details" method="post">
                    ...
                    <select name="courses" value="Course List" placeholder="Course List">
                        ...
                        <?php
                            $getcourse=$view->getCourseList($_SESSION['login']);
                            $result_array = array();
                    ...
                    <?php
                        ...
                        {
                            $gcd=$view->viewCourseDetails($_POST['courses']);
